...
df2 <- df[,-c(1:12, 15:16, 18:24, 26, 29, 37, 39, 43, 45)]
```
...
- 6 numerical variables: `price`, `pricePerSquareFoot`, `yearBuilt`, `livingArea`, `bathrooms`, `bedrooms`.
...
dfnum <- df3[,c(1:2, 4:6, 14)] # year built
