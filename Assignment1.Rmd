...
df2 <- df[,-c(1:12, 15:16, 18:24, 26, 29, 37, 39)]
```
...
- 7 numerical variables: `price`, `pricePerSquareFoot`, `yearBuilt`, `livingArea`, `bathrooms`, `bedrooms`.
- 12 categorical variables: `state`, `parking`, `garageSpaces`, `hasGarage`, `levels`, `pool`, `spa`, `isNewConstruction`, `homeType`, `county`, `f.price`, `f.yearBuilt`.

```{r}
# Numerical variables:
dfnum <- df2[,c(1:6)] # o yearBuilt o n.yearBuilt (escollir una)
